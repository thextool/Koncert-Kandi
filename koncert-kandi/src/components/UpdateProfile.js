    ...
    render() {
        ...
        <div className='form-container'>
            ...
            <div className='form-group mx-sm-3 mb-2'>
                ...
                <input className='form-control col-form-label-sm' type='text' name='first_name' onChange={this.handleChange} placeholder='Enter Name' />
            </div>
            <div className='form-group mx-sm-3 mb-2'>
                <label htmlFor='last_name'>Last Name:</label>
                <input className='form-control' type='text' name='last_name' onChange={this.handleChange} placeholder='Enter Name' />
